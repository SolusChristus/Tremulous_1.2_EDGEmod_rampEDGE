...
============
*/
void G_RandomizeBPS( int randomSeed )
{
  ...
  srand( randomSeed );
  buildPointModifier = rand() % 150;

  newHumanBuildPoints = 100 + buildPointModifier;
  newAlienBuildPoints = 100 + buildPointModifier;
